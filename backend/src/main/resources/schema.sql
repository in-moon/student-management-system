...
INSERT IGNORE INTO `user` (`username`, `password`, `role`) VALUES ('admin', 'admin', 'ADMIN');
...
INSERT IGNORE INTO `class` (`class_no`, `name`, `grade`, `major`, `counselor`, `student_count`) VALUES
...
CREATE TABLE IF NOT EXISTS `student` (
  ...
  `clazz` VARCHAR(100) DEFAULT NULL COMMENT '班级名称',
...
INSERT IGNORE INTO `student` (`student_no`, `name`, `gender`, `age`, `clazz`, `class_id`, `major`, `enroll_date`, `phone`, `email`) VALUES
...
INSERT IGNORE INTO `course` (`course_no`, `name`, `credit`, `teacher`, `semester`, `max_students`, `description`) VALUES
...
CREATE TABLE IF NOT EXISTS `enrollment` (
  ...
  `status` VARCHAR(20) DEFAULT 'ENROLLED' COMMENT '状态',
  PRIMARY KEY (`id`),
...
INSERT IGNORE INTO `enrollment` (`student_id`, `course_id`, `enroll_date`, `score`, `status`) VALUES
